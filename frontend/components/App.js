...
export default function App() {
  ...
  const onChange = evt => {
    ...
    setFormValue(prevValues => ({ ...prevValues, [id]: value }))
  }
  const edit = id => {
  ...
  const submitNewMember = () => {
    ...
    const { fname, lname, bio } = formValue;
      ...
      <div id="membersForm">
        ...
        <form onSubmit={onSubmit}>
          <div>
            ...
            <input onChange={onChange}value={formValue.fname} id="fname" type="text" placeholder="Type First Name" />
          </div>

          <div>
            <label htmlFor="lname">Last Name </label>
            <input onChange={onChange} value={formValue.lname} id="lname" type="text" placeholder="Type Last Name" />
          </div>

          <div>
            <label htmlFor="bio">Bio </label>
            <textarea onChange={onChange} value={formValue.bio} id="bio" placeholder="Type Bio" />
          </div>
